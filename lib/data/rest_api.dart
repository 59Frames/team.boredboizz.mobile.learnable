...
class RestAPI {
  ...
  RestAPI._internal() {
    Pretender()
        ...
        .then((token) => headers["Authorization"] = token);
  }
  ...
  Future<User> getLoggedInUser() async {
    return _netUtil
        .get(_GET_LOGGED_IN_USER, headers: headers)
        .then((dynamic res) {
  ...
  Future<Map<int, Class>> getClasses() async {
    return _netUtil.get(_GET_CLASSES_URL, headers: headers).then((dynamic res) {
  ...
  Future<Map<int, Event>> getEvents() async {
    return _netUtil.get(_GET_EVENTS_URL, headers: headers).then((dynamic res) {
  ...
  Future<Map<int, EventType>> getEventTypes() async {
    return _netUtil
        .get(_GET_EVENT_TYPES_URL, headers: headers)
        .then((dynamic res) {
  ...
  Future<Map<int, Lesson>> getLessons() async {
    return _netUtil.get(_GET_LESSONS_URL, headers: headers).then((dynamic res) {
  ...
  Future<Map<int, School>> getSchools() async {
    return _netUtil.get(_GET_SCHOOLS_URL, headers: headers).then((dynamic res) {
  ...
  Future<Map<int, Course>> getCourses() async {
    return _netUtil.get(_GET_COURSES_URL, headers: headers).then((dynamic res) {
  ...
  Future<Map<int, Teacher>> getTeachers() async {
    return _netUtil
        .get(_GET_TEACHERS_URL, headers: headers)
        .then((dynamic res) {
  ...
  Future<Event> getEventById(int id) async {
    ...
    return _netUtil.get(url, headers: headers).then((dynamic res) async {
  ...
  Future<Map<int, Member>> getClassMembers(int classId) async {
    return _netUtil
        .get("$_GET_CLASS_MEMBERS_URL/class/$classId", headers: headers)
        .then((dynamic res) {
  ...
  Future<Map<int, Teacher>> getClassTeachers(int classId) async {
    return _netUtil
        .get("$_GET_CLASS_TEACHERS_URL/class/$classId", headers: headers)
        .then((dynamic res) {
      Map<int, Teacher> map = Map();
      for (var row in res) {
