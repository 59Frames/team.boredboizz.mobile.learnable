  ...
  Widget build(BuildContext context) {
    var _refreshIndicator = RefreshIndicator(
        ...
        child: ListView(
            ...
            children: _eventMap.length > 0
                ? _getEvents()
                : <Widget>[
                    ListTile(
                        title:
                            Center(child: Text(_localizations.noEventsListed)))
                  ]));

    return Scaffold(
      key: _scaffoldKey,
      backgroundColor: colorConfig.PAGE_BACKGROUND_COLOR,
      body: Container(child: _refreshIndicator),
    );
  }
    ...
    var _tile = InkWell(
      ...
      child: ListTile(
        ...
        title: Text(
          ...
          style: TextStyle(fontSize: 18.0, color: colorConfig.DARK_FONT_COLOR),
        ),
      ),
    );
              ...
              child: Column(
                ...
                children: <Widget>[
                  SimpleTitleDescriptionTile(
                    ...
                    description:
                        _event.eventType != null ? _event.eventType.type : "",
                  ),
                  SimpleTitleDescriptionTile(
                  ...
                  SimpleTitleDescriptionTile(
                    ...
                    description:
                        _event.description != null ? _event.description : "",
                  ),
                  SimpleTitleDescriptionTile(
                    title: _localizations.date,
                    description: dateUtil.getShortDateString(
                        _event.lesson != null ? _event.lesson.start : null),
                  ),
                  SimpleTitleDescriptionTile(
                    title: _localizations.startTime,
                    description: dateUtil.getTimeString(
                        _event.lesson != null ? _event.lesson.start : null),
                  ),
                  SimpleTitleDescriptionTile(
                    title: _localizations.endTime,
                    description: dateUtil.getTimeString(
                        _event.lesson != null ? _event.lesson.end : null),
                  ),
                  SimpleTitleDescriptionTile(
                    title: _localizations.room,
                    description:
                        _event.lesson != null ? _event.lesson.room : "",
                  ),
                  SimpleTitleDescriptionTile(
...
class SimpleTitleDescriptionTile extends StatelessWidget {
  ...
  const SimpleTitleDescriptionTile(
